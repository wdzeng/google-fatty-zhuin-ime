...
.method private static a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;
    ...
    .line 35
    :goto_2
    invoke-static {v1, p0, p1}, Lanq;->a(Landroid/graphics/Rect;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
...
.method private final a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-direct {p0, v0, p2}, Lasf;->a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
...
.method private final a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Z
    ...
    invoke-direct/range {v0 .. v5}, Lasg;-><init>(Lasf;Ljava/lang/Runnable;Landroid/view/View;FF)V

    invoke-virtual {v6, v0}, Landroid/animation/AnimatorSet;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 79
    iput-object v6, p0, Lasf;->a:Landroid/animation/Animator;
...
.method public final animateKeyboardViewSwitch(Landroid/view/View;Landroid/view/View;Ljava/lang/String;ILjava/lang/String;ILjava/lang/Runnable;)Z
    ...
    .line 5
    invoke-virtual/range {p0 .. p6}, Lasf;->shouldAnimate(Landroid/view/View;Landroid/view/View;Ljava/lang/String;ILjava/lang/String;I)Z
    ...
    invoke-static {p1, v1, v0}, Lasf;->a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;

    move-result-object v0

    .line 11
    invoke-direct {p0, p2, p3}, Lasf;->a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 13
    invoke-static {v1, v2, v3}, Lasf;->a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;

    move-result-object v1

    .line 14
    invoke-direct {p0, p1, v0, v1, p7}, Lasf;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Z
    ...
    .line 18
    invoke-direct {p0, p1, p5}, Lasf;->a(Landroid/view/View;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-static {p2, v2, v0}, Lasf;->a(Landroid/view/View;Landroid/view/ViewParent;Z)Landroid/graphics/Rect;

    move-result-object v0

    .line 22
    invoke-direct {p0, p2, v1, v0, p7}, Lasf;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;Ljava/lang/Runnable;)Z
...
.method public final cancelPreviousAnimation()V
    ...
    .prologue
    .line 37
    iget-object v0, p0, Lasf;->a:Landroid/animation/Animator;
