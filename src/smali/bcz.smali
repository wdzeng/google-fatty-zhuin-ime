...
.method public final a(Ljava/lang/String;)V
    ...
    .line 6
    :cond_0
    iget-object v4, p0, Laj;->a:Lrv;

    iget-object v0, p0, Laj;->a:Landroid/content/Context;

    .line 7
    invoke-virtual {v4, v3}, Lrv;->a(Z)V

    .line 8
    new-instance v5, Lru;

    invoke-direct {v5, v0, v4}, Lru;-><init>(Landroid/content/Context;Lrv;)V

    .line 9
    const v0, 0x7f080163

    invoke-virtual {v5, v0, v1}, Lru;->a(ILandroid/support/v7/preference/PreferenceGroup;)Landroid/support/v7/preference/Preference;
    ...
    .line 10
    invoke-virtual {v0, v4}, Landroid/support/v7/preference/PreferenceScreen;->a(Lrv;)V

    .line 11
    invoke-virtual {v4, v2}, Lrv;->a(Z)V
    ...
    .line 21
    iget-object v5, v4, Lrv;->a:Landroid/support/v7/preference/PreferenceScreen;

    if-eq v0, v5, :cond_3

    .line 22
    iget-object v2, v4, Lrv;->a:Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 24
    :cond_2
    iput-object v0, v4, Lrv;->a:Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 35
    iget-object v0, v0, Lrv;->a:Landroid/support/v7/preference/PreferenceScreen;

    .line 36
    const v2, 0x7f1104c7

    invoke-virtual {p0, v2}, Lbcz;->getString(I)Ljava/lang/String;
    ...
    invoke-static {v3, v0}, Lakx;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final a(Landroid/support/v7/preference/Preference;)Z
    ...
    invoke-static {v2, v1}, Lge;->a(Landroid/content/Context;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    .line 52
    invoke-virtual {p0}, Lbcz;->getFragmentManager()Landroid/app/FragmentManager;
    ...
    .line 54
    invoke-virtual {p0, v2}, Lbcz;->startActivity(Landroid/content/Intent;)V
