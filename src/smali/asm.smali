...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/inputmethod/libs/framework/core/IPopupViewManager;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lasm;-><init>(Landroid/content/Context;Lcom/google/android/apps/inputmethod/libs/framework/core/IPopupViewManager;Lcom/google/android/apps/inputmethod/libs/framework/keyboard/AccessPointDragHandler$Delegate;)V
...
.method private constructor <init>(Landroid/content/Context;Lcom/google/android/apps/inputmethod/libs/framework/core/IPopupViewManager;Lcom/google/android/apps/inputmethod/libs/framework/keyboard/AccessPointDragHandler$Delegate;)V
    ...
    iput-object v0, p0, Lasm;->a:[I

    .line 5
    new-array v0, v1, [I

    iput-object v0, p0, Lasm;->b:[I

    .line 6
    new-array v0, v1, [I

    iput-object v0, p0, Lasm;->c:[I

    .line 7
    new-array v0, v1, [I

    iput-object v0, p0, Lasm;->d:[I
    ...
    iput-object v0, p0, Lasm;->b:Ljava/lang/Runnable;

    .line 9
    new-instance v0, Laso;

    invoke-direct {v0, p0}, Laso;-><init>(Lasm;)V

    iput-object v0, p0, Lasm;->c:Ljava/lang/Runnable;

    .line 10
    new-instance v0, Lasp;

    invoke-direct {v0, p0}, Lasp;-><init>(Lasm;)V

    iput-object v0, p0, Lasm;->d:Ljava/lang/Runnable;

    .line 11
    new-instance v0, Lass;

    invoke-direct {v0, p0}, Lass;-><init>(Lasm;)V

    iput-object v0, p0, Lasm;->a:Landroid/view/View$OnAttachStateChangeListener;

    .line 12
    iput-object p1, p0, Lasm;->a:Landroid/content/Context;

    .line 13
    iput-object p2, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IPopupViewManager;
    ...
    iput-object v0, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/AccessPointDragHandler;

    .line 15
    iget-object v0, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/AccessPointDragHandler;
    ...
    .line 20
    iget-object v0, v0, Lcom/google/android/apps/inputmethod/libs/framework/keyboard/AccessPointDragHandler;->a:Larh;
    ...
    .line 23
    iput-object v3, v0, Larh;->a:Landroid/view/View;
...
.method public final a(Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 40
    iget-object v2, p0, Lasm;->a:Laof;

    invoke-virtual {v2}, Laof;->a()Laof;
    ...
    .line 41
    iput-object v3, v2, Laof;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lbyp;->a(Ljava/lang/Object;)Lbyp;
    ...
    iput-boolean v0, v1, Lbyp;->a:Z

    .line 50
    iget-object v0, v1, Lbyp;->a:[Ljava/lang/Object;
...
.method public final a()V
    ...
    .line 52
    iget-object v0, p0, Lasm;->a:Landroid/animation/Animator;
    ...
    .line 63
    :cond_3
    iget-object v1, v0, Lcom/google/android/apps/inputmethod/libs/framework/keyboard/AccessPointDragHandler;->a:Larh;

    .line 64
    iget-object v2, v1, Larh;->a:Landroid/animation/AnimatorSet;
    ...
    .line 65
    iget-object v1, v1, Larh;->a:Landroid/animation/AnimatorSet;
    ...
    .line 68
    :cond_5
    iget-object v0, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/ExpandAccessPointsHintView;
    ...
    iget-object v1, p0, Lasm;->a:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iget-object v1, p0, Lasm;->d:Ljava/lang/Runnable;
    ...
    iget-object v1, p0, Lasm;->b:Ljava/lang/Runnable;
    ...
    iget-object v1, p0, Lasm;->c:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/ExpandAccessPointsHintView;->removeCallbacks(Ljava/lang/Runnable;)Z

    .line 73
    iget-object v0, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IPopupViewManager;

    iget-object v1, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/ExpandAccessPointsHintView;
    ...
    .line 74
    :cond_6
    iput-object v4, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/ExpandAccessPointsHintView;

    .line 75
    iget-object v0, p0, Lasm;->a:Ljava/lang/Runnable;
...
.method final a(IFF)V
    ...
    .line 35
    iget-object v1, p0, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/SoftKeyboardView;
