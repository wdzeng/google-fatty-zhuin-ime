...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;JLcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager;)V
    ...
    .line 6
    iput-object p2, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;

    .line 7
    iput-wide p3, p0, Lacp;->a:J

    .line 8
    iput-object p5, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager;
...
.method public final synthetic createPeriodicalTask(Ljava/lang/String;Lcom/google/android/apps/inputmethod/libs/framework/core/PeriodicalTaskFactory$RunType;)Lcom/google/android/apps/inputmethod/libs/framework/core/Task;
    ...
    iget-object v1, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;
    ...
    invoke-static {v0, v1, v2}, Lanp;->a(Ljava/lang/ClassLoader;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;

    iget-object v3, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager;

    iget-object v4, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;
    ...
    .line 20
    iput-object v1, v0, Lacj;->a:Landroid/content/Context;

    .line 21
    iput-object v2, v0, Lacj;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;

    .line 22
    invoke-virtual {v0, v3}, Lacj;->addListener(Lcom/google/android/apps/inputmethod/libs/framework/core/TaskListener;)Lcom/google/android/apps/inputmethod/libs/framework/core/Task;
...
.method public final getEnabledPreferenceKey()Ljava/lang/String;
    ...
    .prologue
    .line 10
    iget-object v0, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;

    invoke-static {v0}, Lacp;->a(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Ljava/lang/String;
...
.method public final getRetryDelayMillisOnFailure(Lcom/google/android/apps/inputmethod/libs/framework/core/PeriodicalTaskFactory$RunType;)J
    ...
    .prologue
    .line 12
    iget-object v0, p0, Lacp;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager;
