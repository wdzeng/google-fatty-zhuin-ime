...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 1
    invoke-direct {p0, p1}, Laqx;-><init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Latr;->a:Lkk;

    .line 5
    new-instance v0, Landroid/widget/FrameLayout;

    iget-object v1, p0, Latr;->a:Landroid/content/Context;

    invoke-direct {v0, v1}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Latr;->a:Landroid/widget/FrameLayout;

    .line 6
    iget-object v0, p0, Latr;->a:Landroid/widget/FrameLayout;
...
.method public final a()V
    ...
    .line 9
    iget-object v0, p0, Latr;->a:Ljava/util/Set;
    ...
    invoke-static {v0}, Latr;->c(Landroid/view/View;)V

    .line 11
    invoke-super {p0}, Laqx;->a()V
...
.method protected final a(Landroid/graphics/Rect;)V
    ...
    invoke-static {v0, p1}, Lanq;->a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 58
    :cond_0
    invoke-super {p0, p1}, Laqx;->a(Landroid/graphics/Rect;)V
...
.method protected final a(Landroid/view/View;[IZ)V
    ...
    .line 44
    :goto_0
    iget-object v1, p0, Latr;->a:Landroid/widget/FrameLayout;

    iget-object v2, p0, Latr;->a:[I
    ...
    .line 38
    :cond_1
    invoke-static {p1}, Latr;->c(Landroid/view/View;)V
...
.method protected final a(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 13
    invoke-super {p0, p1, p2}, Laqx;->a(Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-object v3, p0, Latr;->a:Landroid/widget/FrameLayout;
    ...
    iget-object v3, p0, Latr;->a:Landroid/view/View;
    ...
    invoke-static {v3}, Latr;->c(Landroid/view/View;)V
