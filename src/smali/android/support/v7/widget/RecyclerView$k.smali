...
.method private final a(I)Landroid/support/v7/widget/RecyclerView$r;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->a:Lyj;

    .line 349
    invoke-virtual {v0, p1, v2}, Lyj;->a(II)I
...
.method private final a(IZ)Landroid/support/v7/widget/RecyclerView$r;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView;->a:Lwj;

    .line 372
    iget-object v0, v4, Lwj;->a:Ljava/util/List;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->a:Lwj;

    .line 388
    iget-object v2, v1, Lwj;->a:Lwl;

    invoke-virtual {v2, v3}, Lwl;->a(Landroid/view/View;)I
    ...
    .line 391
    :cond_6
    iget-object v4, v1, Lwj;->a:Lwk;

    invoke-virtual {v4, v2}, Lwk;->a(I)Z
    ...
    invoke-virtual {v4, v2}, Lwk;->b(I)V

    .line 394
    invoke-virtual {v1, v3}, Lwj;->a(Landroid/view/View;)Z
    ...
    invoke-virtual {v1, v3}, Lwj;->a(Landroid/view/View;)I
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->a:Lwj;

    invoke-virtual {v2, v1}, Lwj;->a(I)V
...
.method public final a(IZJ)Landroid/support/v7/widget/RecyclerView$r;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->a:Lyj;

    invoke-virtual {v1, p1}, Lyj;->a(I)I
    ...
    .line 95
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/RecyclerView$j;->a(I)Lyu;

    move-result-object v0

    iget-wide v6, v0, Lyu;->a:J
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/RecyclerView;->a(Landroid/support/v7/widget/RecyclerView$r;Lyr;)V
    ...
    invoke-virtual {v0, p1}, Lyj;->a(I)I
    ...
    .line 150
    invoke-virtual {v6, v0}, Landroid/support/v7/widget/RecyclerView$j;->a(I)Lyu;

    move-result-object v0

    iget-wide v6, v0, Lyu;->b:J
    ...
    .line 171
    invoke-virtual {v6, v7}, Landroid/support/v7/widget/RecyclerView$j;->a(I)Lyu;

    move-result-object v4

    .line 172
    iget-wide v6, v4, Lyu;->b:J

    invoke-static {v6, v7, v0, v1}, Landroid/support/v7/widget/RecyclerView$j;->a(JJ)J

    move-result-wide v0

    iput-wide v0, v4, Lyu;->b:J
    ...
    invoke-virtual {v1, v0}, Lme;->a(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Llw;->a(Landroid/view/View;I)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->a:Lyx;

    .line 181
    invoke-virtual {v1}, Lyx;->a()Lkr;

    move-result-object v1

    .line 182
    invoke-static {v0, v1}, Llw;->a(Landroid/view/View;Lkr;)V
...
.method final a(Landroid/support/v7/widget/RecyclerView$r;)V
    ...
    invoke-virtual {v3, v0}, Lme;->b(Landroid/view/View;)Z
    ...
    invoke-virtual {v1, p1}, Laag;->c(Landroid/support/v7/widget/RecyclerView$r;)V
...
.method public final a(Landroid/support/v7/widget/RecyclerView$r;Z)V
    ...
    invoke-virtual {v0, p1}, Laag;->c(Landroid/support/v7/widget/RecyclerView$r;)V
    ...
    .line 295
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView$j;->a(I)Lyu;

    move-result-object v2

    iget-object v2, v2, Lyu;->a:Ljava/util/ArrayList;
