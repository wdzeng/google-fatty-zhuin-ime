...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Luk;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 6
    sget-object v0, Lrh;->d:[I

    invoke-static {p1, p2, v0, p3, v2}, Lzo;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lzo;
    ...
    invoke-static {p0, v1}, Llw;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final a(Lsk;)V
    ...
    invoke-direct {v1, p1}, Luo;-><init>(Lsk;)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 65
    invoke-virtual {p1}, Lsk;->a()Landroid/view/Menu;
    ...
    .line 66
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Lus;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Lus;
    ...
    .line 71
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Lus;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Landroid/content/Context;

    invoke-virtual {v0, v2, v3}, Ltk;->a(Ltz;Landroid/content/Context;)V

    .line 72
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Lus;

    invoke-virtual {v0, p0}, Lus;->a(Landroid/view/ViewGroup;)Lub;
    ...
    invoke-static {v0, v2}, Llw;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public onDetachedFromWindow()V
    ...
    .prologue
    .line 15
    invoke-super {p0}, Luk;->onDetachedFromWindow()V
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 164
    :cond_0
    invoke-super {p0, p1}, Luk;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
