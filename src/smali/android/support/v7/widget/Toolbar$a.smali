...
.method public final a(Landroid/content/Context;Ltk;)V
    ...
    .prologue
    .line 3
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar$a;->a:Ltk;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar$a;->a:Lto;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar$a;->a:Lto;

    invoke-virtual {v0, v1}, Ltk;->b(Lto;)Z

    .line 5
    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar$a;->a:Ltk;
...
.method public final a(Z)V
    ...
    .line 9
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar$a;->a:Ltk;
    ...
    .line 12
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar$a;->a:Ltk;

    invoke-virtual {v3, v1}, Ltk;->getItem(I)Landroid/view/MenuItem;

    move-result-object v3

    .line 13
    iget-object v4, p0, Landroid/support/v7/widget/Toolbar$a;->a:Lto;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/Toolbar$a;->c(Lto;)Z
...
.method public final b(Lto;)Z
    ...
    invoke-direct {v1, v2, v3, v4}, Lvn;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0}, Lzq;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    .line 38
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar$a;->a:Lto;
    ...
    .line 56
    invoke-virtual {p1, v6}, Lto;->c(Z)V
...
.method public final c(Lto;)Z
    ...
    .line 71
    iput-object v3, p0, Landroid/support/v7/widget/Toolbar$a;->a:Lto;
    ...
    invoke-virtual {p1, v0}, Lto;->c(Z)V
