...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Loz;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-direct {v0, p0}, Lpe;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-direct {v0, p0}, Lpf;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;
    ...
    invoke-direct {v1, v2, p0}, Loo;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Loo;

    .line 38
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Loo;

    .line 39
    iget-object v1, v1, Loo;->a:Los;
    ...
    .line 41
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Loo;

    invoke-virtual {v1, v2}, Lob;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v1, v2}, Lob;->setVisibility(I)V
    ...
    .line 44
    invoke-static {p0}, Llw;->a(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lls;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Llq;
...
.method private final a(II)Landroid/view/animation/Animation;
    ...
    invoke-direct {v0, p0, p1, p2}, Lpc;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;II)V
    ...
    iput-object v2, v1, Lob;->a:Landroid/view/animation/Animation$AnimationListener;

    .line 114
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v1}, Lob;->clearAnimation()V

    .line 115
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v1, v0}, Lob;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private final a(ZZ)V
    ...
    .line 96
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    .line 97
    iput-object v1, v0, Lob;->a:Landroid/view/animation/Animation$AnimationListener;

    .line 98
    :cond_0
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v0}, Lob;->clearAnimation()V
    ...
    invoke-virtual {v0, v1}, Lob;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private final b()V
    ...
    .line 120
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;
...
.method private final c(F)V
    ...
    .line 250
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Loo;
    ...
    .line 260
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v3}, Lob;->getVisibility()I
    ...
    invoke-virtual {v3, v4}, Lob;->setVisibility(I)V

    .line 262
    :cond_0
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v3, v10}, Lob;->setScaleX(F)V

    .line 263
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v3, v10}, Lob;->setScaleY(F)V
    ...
    .line 265
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Loo;

    invoke-virtual {v3}, Loo;->getAlpha()I
    ...
    .line 274
    iget-object v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Loo;

    invoke-static {v12, v3}, Ljava/lang/Math;->min(FF)F

    move-result v3

    invoke-virtual {v4, v3}, Loo;->b(F)V
    ...
    invoke-virtual {v3, v4}, Loo;->a(F)V
    ...
    .line 278
    iget-object v2, v2, Loo;->a:Los;

    invoke-virtual {v2, v1}, Los;->c(F)V
...
.method private final d(F)V
    ...
    invoke-virtual {v0, v1}, Loo;->b(F)V

    .line 285
    new-instance v0, Lpd;

    invoke-direct {v0, p0}, Lpd;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    .line 292
    iput-object v0, v1, Lob;->a:Landroid/view/animation/Animation$AnimationListener;
...
.method public final a()V
    ...
    invoke-virtual {v0, v1}, Lob;->setVisibility(I)V

    .line 5
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v0}, Lob;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v2}, Loo;->setAlpha(I)V
    ...
    invoke-virtual {v0}, Lob;->getTop()I
...
.method public final a(F)V
    ...
    invoke-virtual {v0, p1}, Lob;->setScaleX(F)V

    .line 83
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lob;

    invoke-virtual {v0, p1}, Lob;->setScaleY(F)V
...
.method public final a(I)V
    ...
    invoke-virtual {v0}, Lob;->bringToFront()V
    ...
    invoke-virtual {v1, v0, p1}, Lme;->b(Landroid/view/View;I)V
...
.method public final a(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-direct {v0, p0}, Lpb;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    .line 106
    iput-object p1, v0, Lob;->a:Landroid/view/animation/Animation$AnimationListener;
...
.method public final a(Z)V
    ...
    invoke-virtual {v1, v2}, Loo;->setAlpha(I)V

    .line 72
    :cond_0
    new-instance v1, Lpa;

    invoke-direct {v1, p0}, Lpa;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method public final b(F)V
    ...
    invoke-virtual {v1}, Lob;->getTop()I
...
.method public dispatchNestedFling(FFZ)Z
    ...
    .prologue
    .line 247
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Llq;
...
.method public getNestedScrollAxes()I
    ...
    .prologue
    .line 217
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Lls;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2}, Lob;->getTop()I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v1}, Lob;->getMeasuredWidth()I
    ...
    invoke-virtual {v2}, Lob;->getMeasuredHeight()I
    ...
    invoke-virtual {v3, v4, v5, v0, v1}, Lob;->layout(IIII)V
...
.method public onMeasure(II)V
    ...
    .line 156
    invoke-virtual {v0, v1, v2}, Lob;->measure(II)V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    invoke-virtual {v1, v0}, Lme;->f(Landroid/view/View;)Z
