...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p1}, Landroid/support/v4/widget/NestedScrollView$b;-><init>(Landroid/content/Context;)V

    .line 10
    invoke-static {p1}, Lanp;->a(Landroid/content/Context;)Z
    ...
    .line 12
    invoke-direct {p0, p1, v0, v1, v2}, Laek;-><init>(Landroid/content/Context;Lain;ZLcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;)V

    .line 13
    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lain;ZLcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Laek;->a:Lain;

    .line 4
    iput-boolean p3, p0, Laek;->a:Z

    .line 5
    iput-object p4, p0, Laek;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;
...
.method static a(ILandroid/content/Context;Ljava/util/Locale;Laeg;)V
    .locals 2
    ...
    invoke-direct {v1, p1, p0, p3, p2}, Lael;-><init>(Landroid/content/Context;ILaeg;Ljava/util/Locale;)V
...
.method private final declared-synchronized a(Ljava/util/Locale;Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadManager;Laeg;ZLcom/google/android/apps/inputmethod/libs/dataservice/download/DownloadListener;)V
    .locals 7
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p3, p1}, Laeg;->a(Ljava/util/Locale;)Laei;

    move-result-object v0

    .line 46
    iget-object v0, v0, Laei;->a:Lchp;
    ...
    invoke-virtual {p3, p1, v2, v3}, Laeg;->a(Ljava/util/Locale;J)I
    ...
    iget-object v6, p0, Laek;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;

    invoke-direct {v4, v5, v2, p3, v6}, Laem;-><init>(Landroid/content/Context;Lain;Laeg;Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;)V
    ...
    .line 78
    invoke-static {v0}, Laen;->a(Lchp;)Laeo;
    ...
    iget-object v6, v0, Lchp;->e:Ljava/lang/String;
    ...
    invoke-virtual {p3, p1, v0, v1}, Laeg;->a(Ljava/util/Locale;J)V

    .line 102
    if-eqz p4, :cond_0

    .line 103
    iget-object v0, p0, Laek;->a:Landroid/content/Context;

    invoke-static {v0}, Laij;->d(Landroid/content/Context;)Z
    ...
    invoke-static {v0, v1, p1, p3}, Laek;->a(ILandroid/content/Context;Ljava/util/Locale;Laeg;)V
    :try_end_2
...
.method static a(Landroid/content/Context;Ljava/lang/String;Laeg;Lcom/google/inputmethod/keyboard/decoder/nano/KeyboardDecoderProtos$LanguageModelDescriptor;Lain;Ladn;Z)Z
    .locals 10
    ...
    invoke-static {v0, v1}, Lge;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Locale;

    move-result-object v2

    .line 112
    invoke-static {p0, v2}, Laef;->a(Landroid/content/Context;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual {p4, v3, v4, v5, v1}, Lain;->a(Ljava/lang/String;IILjava/io/File;)Z
    ...
    .line 119
    invoke-static {p1, v4}, Laek;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 122
    :cond_0
    invoke-static {p0, v2}, Laef;->b(Landroid/content/Context;Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 128
    invoke-static {v0, v2}, Laen;->a(Ljava/lang/String;Ljava/util/Locale;)Lcom/google/inputmethod/keyboard/decoder/nano/KeyboardDecoderProtos$LanguageModelDescriptor;
    ...
    .line 131
    iget-object v5, p5, Ladn;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;
    ...
    .line 132
    iget-object v8, p5, Ladn;->a:Lcom/google/android/keyboard/client/delight4/Decoder;
    ...
    invoke-virtual {p4, v1, v6, v7}, Lain;->a(Ljava/lang/String;II)Ljava/lang/String;
    ...
    .line 166
    invoke-virtual {p4, v5}, Lain;->b(Ljava/io/File;)Z
    ...
    .line 142
    invoke-virtual {p4, v1, v5}, Lain;->b(Ljava/io/File;Ljava/io/File;)Z
    ...
    .line 145
    invoke-virtual {p4, v1}, Lain;->b(Ljava/io/File;)Z
    ...
    .line 160
    :cond_4
    invoke-virtual {p2, v2}, Laeg;->a(Ljava/util/Locale;)Ljava/lang/String;
    ...
    .line 173
    :cond_7
    invoke-virtual {p5, v0}, Ladn;->a(Lcom/google/inputmethod/keyboard/decoder/nano/KeyboardDecoderProtos$LanguageModelDescriptor;)J
    ...
    .line 182
    :cond_8
    invoke-virtual {p4, v5, v4}, Lain;->c(Ljava/io/File;Ljava/io/File;)Z
    ...
    .line 190
    invoke-virtual {p2, v2, v6, v7, v4}, Laeg;->a(Ljava/util/Locale;JLjava/io/File;)Z
    ...
    .line 192
    invoke-virtual {p2, p5}, Laeg;->a(Ladn;)V
...
# virtual methods
.method public final declared-synchronized a(Ljava/util/Locale;Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadManager;Laeg;Z)V
    .locals 10
    ...
    .line 16
    invoke-virtual {p3, v1}, Laeg;->a(Ljava/util/Locale;)Laei;

    move-result-object v0

    .line 17
    iget-object v4, v0, Laei;->a:Lcom/google/inputmethod/keyboard/decoder/nano/KeyboardDecoderProtos$LanguageModelDescriptor;

    .line 18
    iget-object v5, v0, Laei;->a:Lchp;
    ...
    :cond_0
    :try_start_1
    iget-wide v6, v5, Lchp;->a:J

    invoke-virtual {p3, v1, v6, v7}, Laeg;->a(Ljava/util/Locale;J)I
    ...
    invoke-direct/range {v0 .. v5}, Laek;->a(Ljava/util/Locale;Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadManager;Laeg;ZLcom/google/android/apps/inputmethod/libs/dataservice/download/DownloadListener;)V
