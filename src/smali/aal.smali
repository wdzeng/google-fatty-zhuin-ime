...
# direct methods
.method public constructor <init>(Landroid/content/Context;Laam;)V
    .locals 3
    ...
    invoke-direct {v0, v1, v2}, Laan;-><init>(Landroid/os/Looper;Ljava/lang/ref/WeakReference;)V

    iput-object v0, p0, Laal;->a:Laan;

    .line 5
    iput-object p1, p0, Laal;->a:Landroid/content/Context;

    .line 6
    iput-object p2, p0, Laal;->a:Laam;
...
.method public final a(Laau;)Z
    ...
    .line 11
    invoke-virtual {v0, v2}, Laan;->obtainMessage(I)Landroid/os/Message;

    move-result-object v0

    invoke-direct {v1, p1, v0}, Laaz;-><init>(Laau;Landroid/os/Message;)V

    .line 12
    iget-object v2, p0, Laal;->a:Lkm;

    monitor-enter v2

    .line 13
    :try_start_0
    iget-object v0, p0, Laal;->a:Lkm;
    ...
    .line 18
    iget-object v4, p0, Laal;->a:Landroid/content/Context;

    invoke-interface {p1}, Laaw;->a()Ljava/lang/String;
