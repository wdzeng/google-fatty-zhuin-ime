...
# direct methods
.method private constructor <init>(Landroid/content/Context;Lain;Laeg;Ladn;Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Laem;->a:Lain;

    .line 4
    iput-object p3, p0, Laem;->a:Laeg;

    .line 5
    iput-object p4, p0, Laem;->a:Ladn;

    .line 6
    iput-object p5, p0, Laem;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;

    .line 7
    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lain;Laeg;Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;)V
    .locals 6
    ...
    .line 12
    invoke-direct/range {v0 .. v5}, Laem;-><init>(Landroid/content/Context;Lain;Laeg;Ladn;Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;)V
...
.method public final onDownloadFailed(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DownloadablePackageUpdateInfo;)V
    ...
    invoke-virtual {v1, v0, v2, v3}, Laeg;->b(Ljava/util/Locale;J)V

    .line 31
    iget-object v1, p0, Laem;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;
    ...
    invoke-virtual {v0, p1, p2}, Ladq;->onDownloadFailed(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DownloadablePackageUpdateInfo;)V
...
.method public final varargs onDownloadSuccess(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DownloadablePackageUpdateInfo;[Ljava/io/File;)V
    ...
    invoke-static {v1, v2}, Lge;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Locale;
    ...
    .line 19
    invoke-static {v6, v0, v7}, Laen;->a(ILjava/io/File;Ljava/util/Locale;)Lcom/google/inputmethod/keyboard/decoder/nano/KeyboardDecoderProtos$LanguageModelDescriptor;

    move-result-object v3

    .line 20
    iget-object v0, p0, Laem;->a:Landroid/content/Context;

    const/4 v1, 0x0

    iget-object v2, p0, Laem;->a:Laeg;

    iget-object v4, p0, Laem;->a:Lain;

    iget-object v5, p0, Laem;->a:Ladn;
    ...
    .line 21
    iget-object v0, p0, Laem;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IMetrics;
    ...
    invoke-virtual {v0, p1, p2, p3}, Ladq;->onDownloadSuccess(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DownloadablePackageUpdateInfo;[Ljava/io/File;)V
    ...
    .line 26
    invoke-static {v0, v1, v7, v2}, Laek;->a(ILandroid/content/Context;Ljava/util/Locale;Laeg;)V
