...
.method public constructor <init>(Landroid/content/res/AssetManager;Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/ThemePackageProto$ThemePackageMetadata;)V
    ...
    .line 8
    iput-object p1, p0, Lazy;->a:Landroid/content/res/AssetManager;

    .line 9
    iput-object p2, p0, Lazy;->a:Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/ThemePackageProto$ThemePackageMetadata;
...
.method public static a(Landroid/content/res/AssetManager;Ljava/util/List;Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/StyleSheetProto$StyleSheet;)Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/StyleSheetProto$StyleSheet;
    ...
    .line 19
    invoke-static {p0, v0}, Lge;->a(Landroid/content/res/AssetManager;Ljava/lang/String;)[B
    ...
    :cond_1
    :try_start_0
    invoke-static {v1, v3}, Lcie;->a(Lcie;[B)Lcie;
    :try_end_0
...
.method public static a(Landroid/content/res/AssetManager;Ljava/lang/String;)Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/ThemePackageProto$ThemePackageMetadata;
    ...
    .prologue
    .line 1
    invoke-static {p0, p1}, Lge;->a(Landroid/content/res/AssetManager;Ljava/lang/String;)[B
...
.method public final getMetadata()Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/ThemePackageProto$ThemePackageMetadata;
    ...
    .prologue
    .line 11
    iget-object v0, p0, Lazy;->a:Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/ThemePackageProto$ThemePackageMetadata;
...
.method public final getStyleSheet(Ljava/util/Set;Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/StyleSheetProto$StyleSheet;)Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/StyleSheetProto$StyleSheet;
    ...
    .line 13
    invoke-static {v0, p1}, Lbat;->a(Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/ThemePackageProto$ThemePackageMetadata;Ljava/util/Set;)Ljava/util/List;

    move-result-object v0

    .line 14
    iget-object v1, p0, Lazy;->a:Landroid/content/res/AssetManager;

    invoke-static {v1, v0, p2}, Lazy;->a(Landroid/content/res/AssetManager;Ljava/util/List;Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/StyleSheetProto$StyleSheet;)Lcom/google/android/apps/inputmethod/libs/theme/proto/nano/StyleSheetProto$StyleSheet;
