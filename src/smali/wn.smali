...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lwn;-><init>(Landroid/support/v7/widget/Toolbar;ZI)V
...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;ZI)V
    ...
    .line 54
    iput-object v0, p0, Lwn;->a:Ljava/lang/CharSequence;

    .line 56
    iget-object v0, p1, Landroid/support/v7/widget/Toolbar;->c:Ljava/lang/CharSequence;

    .line 57
    iput-object v0, p0, Lwn;->b:Ljava/lang/CharSequence;

    .line 58
    iget-object v0, p0, Lwn;->a:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Lwn;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v3, v4, v5, v2}, Lzo;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lzo;
    ...
    invoke-virtual {v0, v4}, Lzo;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    iput-object v4, p0, Lwn;->d:Landroid/graphics/drawable/Drawable;

    .line 62
    sget v4, Lrh;->r:I

    invoke-virtual {v0, v4}, Lzo;->a(I)Ljava/lang/CharSequence;
    ...
    .line 65
    iput-boolean v1, p0, Lwn;->b:Z

    .line 66
    invoke-direct {p0, v4}, Lwn;->b(Ljava/lang/CharSequence;)V

    .line 67
    :cond_0
    sget v1, Lrh;->p:I

    invoke-virtual {v0, v1}, Lzo;->a(I)Ljava/lang/CharSequence;
    ...
    .line 70
    iput-object v1, p0, Lwn;->b:Ljava/lang/CharSequence;
    ...
    .line 72
    iget-object v4, p0, Lwn;->a:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-virtual {v0, v1}, Lzo;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 76
    iput-object v1, p0, Lwn;->b:Landroid/graphics/drawable/Drawable;

    .line 77
    invoke-direct {p0}, Lwn;->b()V
    ...
    .line 81
    iput-object v1, p0, Lwn;->a:Landroid/graphics/drawable/Drawable;
    ...
    .line 83
    :cond_3
    iget-object v1, p0, Lwn;->c:Landroid/graphics/drawable/Drawable;

    if-nez v1, :cond_4

    iget-object v1, p0, Lwn;->d:Landroid/graphics/drawable/Drawable;
    ...
    .line 85
    iput-object v1, p0, Lwn;->c:Landroid/graphics/drawable/Drawable;

    .line 86
    invoke-direct {p0}, Lwn;->c()V

    .line 87
    :cond_4
    sget v1, Lrh;->h:I

    invoke-virtual {v0, v1, v2}, Lzo;->a(II)I
    ...
    invoke-virtual {v0, v1, v2}, Lzo;->g(II)I
    ...
    iget-object v5, p0, Lwn;->a:Landroid/support/v7/widget/Toolbar;
    ...
    .line 91
    iget-object v4, p0, Lwn;->b:Landroid/view/View;
    ...
    .line 95
    iget-object v1, p0, Lwn;->a:Landroid/support/v7/widget/Toolbar;
    ...
    invoke-virtual {v0, v1, v2}, Lzo;->f(II)I
    ...
    invoke-virtual {v0, v1, v6}, Lzo;->d(II)I
    ...
    invoke-virtual {v0, v4, v6}, Lzo;->d(II)I
    ...
    .line 109
    iget-object v5, v5, Landroid/support/v7/widget/Toolbar;->a:Lza;

    invoke-virtual {v5, v1, v4}, Lza;->a(II)V
    ...
    .line 124
    iget-object v2, p0, Lwn;->a:Landroid/support/v7/widget/Toolbar;
    ...
    .line 135
    :goto_1
    iput-object v0, p0, Lwn;->c:Ljava/lang/CharSequence;

    .line 136
    invoke-direct {p0}, Lwn;->d()V
    ...
    invoke-direct {v1, p0}, Lzs;-><init>(Lwn;)V
...
.method private b()V
    ...
    .line 149
    iget-object v0, p0, Lwn;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 149
    :cond_1
    iget-object v0, p0, Lwn;->a:Landroid/graphics/drawable/Drawable;
...
.method private b(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 142
    iput-object p1, p0, Lwn;->a:Ljava/lang/CharSequence;
...
.method private c()V
    ...
    iget-object v0, p0, Lwn;->c:Landroid/graphics/drawable/Drawable;
    ...
    .line 154
    :cond_0
    iget-object v0, p0, Lwn;->d:Landroid/graphics/drawable/Drawable;
...
.method private d()V
    ...
    .line 158
    iget-object v0, p0, Lwn;->c:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lwn;->c:Ljava/lang/CharSequence;
...
.method public final a(IJ)Lmp;
    ...
    .line 42
    :goto_0
    invoke-virtual {v1, v0}, Lmp;->a(F)Lmp;

    move-result-object v0

    .line 43
    invoke-virtual {v0, p2, p3}, Lmp;->a(J)Lmp;

    move-result-object v0

    new-instance v1, Lzt;

    invoke-direct {v1, p0, p1}, Lzt;-><init>(Lwn;I)V
...
.method public final a(I)V
    ...
    iget-object v2, p0, Lwn;->a:Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Lwn;->b:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lwn;->b:Landroid/view/View;
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 4
    iget-boolean v0, p0, Lwn;->b:Z

    if-nez v0, :cond_0

    .line 5
    invoke-direct {p0, p1}, Lwn;->b(Ljava/lang/CharSequence;)V
...
.method public final a(Lzb;)V
    ...
    .prologue
    .line 37
    iget-object v0, p0, Lwn;->a:Landroid/view/View;
    ...
    iput-object v0, p0, Lwn;->a:Landroid/view/View;
...
.method public final a()Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar$a;->a:Lto;
...
.method public final b()Z
    ...
    .line 9
    iget-object v3, v2, Landroid/support/v7/widget/ActionMenuView;->a:Lus;

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroid/support/v7/widget/ActionMenuView;->a:Lus;

    invoke-virtual {v2}, Lus;->c()Z
