...
.method public constructor <init>(Lcom/google/android/apps/inputmethod/libs/tv/keyboard/widget/FocusPointerUnderlayView;)V
    ...
    invoke-direct {v0, p0}, Lbcv;-><init>(Lbcu;)V

    iput-object v0, p0, Lbcu;->a:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object v0, p0, Lbcu;->a:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lbcu;->b:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lbcu;->c:Landroid/graphics/Rect;

    .line 6
    iput-object p1, p0, Lbcu;->a:Lcom/google/android/apps/inputmethod/libs/tv/keyboard/widget/FocusPointerUnderlayView;
    ...
    iget-object v3, p0, Lbcu;->a:Landroid/graphics/Rect;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Lbcu;->b:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lbcu;->a:Landroid/animation/ValueAnimator;

    .line 10
    iget-object v0, p0, Lbcu;->a:Landroid/animation/ValueAnimator;

    iget-object v1, p0, Lbcu;->a:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v1, p0, Lbcu;->a:Lcom/google/android/apps/inputmethod/libs/tv/keyboard/widget/FocusPointerUnderlayView;
...
.method public final a(Landroid/graphics/Rect;)V
    ...
    .line 17
    invoke-virtual {p0, p1}, Lbcu;->c(Landroid/graphics/Rect;)V
...
.method public final b(Landroid/graphics/Rect;)V
    ...
    .line 20
    iget-object v0, p0, Lbcu;->a:Landroid/graphics/Rect;

    iget-object v1, p0, Lbcu;->c:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    .line 21
    iget-object v0, p0, Lbcu;->b:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lbcu;->a:Landroid/graphics/Rect;
...
.method final c(Landroid/graphics/Rect;)V
    ...
    .line 31
    iget-object v0, p0, Lbcu;->c:Landroid/graphics/Rect;

    invoke-virtual {v0, p1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    .line 32
    iget-object v0, p0, Lbcu;->a:Lcom/google/android/apps/inputmethod/libs/tv/keyboard/widget/FocusPointerUnderlayView;
