...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Laun;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public acceptMotionEvent()Z
    ...
    .prologue
    .line 25
    iget-object v0, p0, Laun;->a:Lauo;

    invoke-virtual {v0}, Lauo;->acceptMotionEvent()Z
...
.method public cancelable()Z
    ...
    invoke-virtual {v0}, Lauo;->cancelable()Z
...
.method public handle(FFZ)Lcom/google/android/apps/inputmethod/libs/framework/core/KeyData;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lauo;->handle(FFZ)Lcom/google/android/apps/inputmethod/libs/framework/core/KeyData;
...
.method public init(Landroid/view/View;Landroid/view/View;FFLcom/google/android/apps/inputmethod/libs/framework/core/metadata/ActionDef;[IZ)Lcom/google/android/apps/inputmethod/libs/framework/core/KeyData;
    ...
    .prologue
    .line 18
    iget-object v0, p0, Laun;->a:Lawi;

    invoke-virtual {v0, p0}, Lawi;->b(Landroid/view/View;)V

    .line 19
    iput-object p2, p0, Laun;->a:Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v7}, Lauo;->init(Landroid/view/View;Landroid/view/View;FFLcom/google/android/apps/inputmethod/libs/framework/core/metadata/ActionDef;[IZ)Lcom/google/android/apps/inputmethod/libs/framework/core/KeyData;

    move-result-object v0

    .line 21
    invoke-virtual {p0, p6}, Laun;->a([I)V
...
.method public onFinishInflate()V
    ...
    invoke-virtual {v0, p0}, Lawi;->a(Landroid/view/View;)V

    .line 16
    const v0, 0x7f0f01dc

    invoke-virtual {p0, v0}, Laun;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Lauo;

    iput-object v0, p0, Laun;->a:Lauo;
...
.method public setSubViewsOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v0, p1}, Lauo;->setSubViewsOnClickListener(Landroid/view/View$OnClickListener;)V
