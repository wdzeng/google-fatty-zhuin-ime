...
.method public final declared-synchronized onPerformSync(Landroid/accounts/Account;Landroid/os/Bundle;Ljava/lang/String;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lbdk;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v1, p0}, Lbdm;->registerTaskListener(Lcom/google/android/apps/inputmethod/libs/framework/core/TaskListener;)V
    ...
    .line 15
    invoke-virtual {v1, v2, v3, v4, v5}, Lahs;->a(Ljava/lang/String;Lcom/google/android/apps/inputmethod/libs/framework/core/TaskFactory;J)V
    ...
    invoke-virtual {v1, p0}, Lbdm;->unregisterTaskListener(Lcom/google/android/apps/inputmethod/libs/framework/core/TaskListener;)V
    ...
    invoke-direct {v3, v0, p0, v4, v5}, Lafn;-><init>(Landroid/content/Context;Lcom/google/android/apps/inputmethod/libs/framework/core/TaskListener;Ljava/lang/String;B)V
