...
.method public constructor <init>(Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsManager;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lahd;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsManager;
...
.method public final dispatchSoftKeyEvent(Lcom/google/android/apps/inputmethod/libs/framework/core/Event;)V
    ...
    .prologue
    .line 94
    iget-object v0, p0, Lahd;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsManager;
...
.method public final onAccessPointsHintShown()V
    ...
    iget-object v1, p0, Lahd;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsManager;

    .line 9
    iget-object v1, v1, Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsManager;->a:Lamo;

    .line 10
    sget v2, Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsManager;->b:I

    .line 12
    invoke-virtual {v1, v2}, Lamo;->a(I)I
...
.method public final onMoreAccessPointsShown()V
    ...
    .line 23
    iget-object v7, p0, Lahd;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsManager;
    ...
    invoke-virtual {v0, v1, v4}, Lamo;->a(IZ)Z
    ...
    .line 27
    iget-object v1, v0, Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsViewHelper;->a:Lasm;
    ...
    invoke-direct {v1, v2, v3}, Lasm;-><init>(Landroid/content/Context;Lcom/google/android/apps/inputmethod/libs/framework/core/IPopupViewManager;)V

    iput-object v1, v0, Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsViewHelper;->a:Lasm;
    ...
    invoke-direct {v2, v0}, Lahg;-><init>(Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsViewHelper;)V

    .line 30
    iput-object v2, v1, Lasm;->a:Ljava/lang/Runnable;

    .line 31
    iget-object v8, v0, Lcom/google/android/apps/inputmethod/libs/framework/core/AccessPointsViewHelper;->a:Lasm;
    ...
    .line 33
    iget-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/ExpandAccessPointsHintView;

    if-nez v0, :cond_1

    .line 34
    iget-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/IPopupViewManager;
    ...
    iput-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/ExpandAccessPointsHintView;
    ...
    iput-object v0, v8, Lasm;->a:Landroid/view/View;
    ...
    invoke-direct {v0, v8}, Lasq;-><init>(Lasm;)V
    ...
    iput-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/AccessPointsBar;
    ...
    iput-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/SoftKeyboardView;
    ...
    iput-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/AccessPointsPanel;

    .line 43
    iget-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/AccessPointsBar;

    .line 44
    const-string v3, "access_point_bar"

    invoke-virtual {v8, v3, v6}, Lasm;->a(Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 47
    iget-object v3, v8, Lasm;->a:Laof;

    invoke-virtual {v3}, Laof;->a()Laof;
    ...
    .line 49
    iput-object v5, v3, Laof;->a:Ljava/lang/String;
    ...
    .line 54
    invoke-virtual {v3}, Laof;->a()Laoe;

    move-result-object v3

    .line 55
    invoke-virtual {v0, v3}, Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/AccessPointsBar;->a(Laoe;)V
    ...
    .line 57
    iget-object v0, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/AccessPointsPanel;
    ...
    invoke-virtual {v8, v3, v5}, Lasm;->a(Ljava/lang/String;I)Ljava/util/List;
    ...
    invoke-direct {v3, v8, v1}, Lasr;-><init>(Lasm;Landroid/view/View;)V
    ...
    iget-object v1, v8, Lasm;->a:Landroid/view/View$OnAttachStateChangeListener;
    ...
    .line 63
    :cond_1
    iget-object v0, v8, Lasm;->a:Landroid/view/View;
    ...
    iget-object v1, v8, Lasm;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/ExpandAccessPointsHintView;
    ...
    invoke-direct {v1, v8}, Lasu;-><init>(Lasm;)V
    ...
    .line 69
    invoke-virtual {v0, v1, v9, v4}, Lamo;->a(IZZ)V
    ...
    .line 67
    :cond_4
    iget-object v0, v8, Lasm;->b:Ljava/lang/Runnable;
