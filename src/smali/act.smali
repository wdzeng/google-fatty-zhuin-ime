...
.method protected final a(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)V
    ...
    iget-wide v4, p0, Lact;->a:J

    move-object v3, p1

    move-object v6, p0

    invoke-direct/range {v1 .. v6}, Lacp;-><init>(Landroid/content/Context;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;JLcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager;)V
    ...
    .line 11
    invoke-static {v2}, Lact;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2, v1}, Lamf;->a(Ljava/lang/String;Lcom/google/android/apps/inputmethod/libs/framework/core/PeriodicalTaskFactory;)V
...
.method public final declared-synchronized isDownloading(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Z
    ...
    .line 3
    invoke-static {v1}, Lact;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lahs;->a(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lact;->a:Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadManager;
...
.method public final runCheckUpdateTaskAndDownload(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Lami;-><init>(Lamf;Ljava/lang/String;Lcom/google/android/apps/inputmethod/libs/framework/core/TaskListener;)V

    .line 16
    invoke-virtual {v0, v2}, Lamf;->a(Ljava/lang/Runnable;)V
