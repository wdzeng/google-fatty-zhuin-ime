...
.method private final a(Ljava/lang/String;)Lcbp;
    .locals 2
    ...
    invoke-static {p0, v0}, Lcbp;->a(Landroid/content/Context;Landroid/os/Bundle;)Lcbp;
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcbk;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Lcbi;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lcbi;->a()Lcbs;

    move-result-object v0

    if-eqz v0, :cond_2

    sget-object v1, Lcbp;->b:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcbs;->a(Ljava/lang/String;)Z
    ...
    .line 41
    sget-object v0, Lcbi;->a:Lcbq;

    .line 42
    invoke-virtual {v0}, Lcbq;->a()Ljava/lang/String;
...
.method private final a(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, v1}, Lcbj;-><init>(Lcom/google/firebase/iid/FirebaseInstanceIdService;I)V
...
.method private final c(Landroid/content/Intent;)V
    ...
    .line 25
    :try_start_2
    iget-object v1, v0, Lcbi;->a:Ljava/lang/String;

    const-string v2, "*"

    .line 26
    iget-object v3, v0, Lcbi;->a:Lcbp;

    const/4 v4, 0x0

    invoke-virtual {v3, v1, v2, v4}, Lcbp;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/google/firebase/iid/FirebaseInstanceIdService;->a(Landroid/content/Context;Lcbi;)V
    :try_end_2
    ...
    .line 28
    :cond_3
    sget-object v5, Lcbi;->a:Lcbq;

    .line 29
    invoke-virtual {v5}, Lcbq;->a()Ljava/lang/String;
    ...
    :cond_5
    :goto_3
    invoke-virtual {v5, v4}, Lcbq;->a(Ljava/lang/String;)Z
    ...
    .line 30
    invoke-virtual {v1}, Lcbi;->a()Ljava/lang/String;
    ...
    :goto_5
    invoke-virtual {v8, v1, v0, v7}, Lcbp;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 33
    :cond_c
    sget-object v6, Lcbp;->a:Lcbr;

    iget-object v9, v8, Lcbp;->a:Ljava/lang/String;

    invoke-virtual {v6, v9, v0, v1}, Lcbr;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v0, Lcbp;->a:Lcbk;

    invoke-virtual {v8}, Lcbp;->a()Ljava/security/KeyPair;

    move-result-object v1

    invoke-virtual {v0, v7, v1}, Lcbk;->a(Landroid/os/Bundle;Ljava/security/KeyPair;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {v0}, Lcbk;->a(Landroid/content/Intent;)Ljava/lang/String;

    goto/16 :goto_3

    :cond_e
    iget-object v1, v8, Lcbp;->a:Ljava/lang/String;

    goto :goto_8

    :cond_f
    iget-object v0, v8, Lcbp;->a:Ljava/lang/String;
    :try_end_6
...
.method public final a(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/iid/FirebaseInstanceIdService;->a(Ljava/lang/String;)Lcbp;
    ...
    :cond_2
    invoke-virtual {v1, v0}, Lcbr;->b(Ljava/lang/String;)V

    .line 8
    sget-object v0, Lcbp;->a:Lcbk;

    .line 9
    invoke-virtual {v0, p1}, Lcbk;->b(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v3}, Lcbk;->a(Landroid/content/Intent;)V
