...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/android/apps/inputmethod/libs/hmm/DictionaryAccessor;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->mPreferences:Lamo;
...
.method private checkServerVersion()Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask$ServerVersion;
    ...
    iget-object v3, p0, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->mPreferences:Lamo;
    ...
    .line 39
    invoke-virtual {v3, v4, v5}, Lamo;->a(Ljava/lang/String;I)I
    ...
    invoke-static {v0}, Lge;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {v0, v6, v5, v3}, Lbxw;-><init>([Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    .line 48
    invoke-virtual {v4, v0}, Lbxu;->a(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method private getEntry(Lcal;)Lcom/google/android/apps/inputmethod/libs/hmm/MutableDictionaryAccessorInterface$Entry;
    .locals 10
    ...
    invoke-virtual {p1, v0}, Lcal;->a(I)Ljava/lang/String;
    ...
    .line 149
    invoke-virtual {p1, v6}, Lcal;->a(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0, v2}, Lcal;->a(II)Ljava/lang/Object;
...
.method private update()I
    ...
    .line 22
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->mPreferences:Lamo;

    const-string v4, "ext_dict_version"

    const/16 v5, 0x7d

    invoke-virtual {v0, v4, v5}, Lamo;->a(Ljava/lang/String;I)I
    ...
    .line 30
    iget-object v2, p0, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->mPreferences:Lamo;

    iget-object v3, p0, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->mPreferences:Lamo;

    .line 31
    invoke-virtual {v3, v10}, Lamo;->a(I)I
    ...
    .line 34
    invoke-virtual {v2, v10, v3, v1}, Lamo;->a(IIZ)V
...
.method private updateAllVersions(Ljava/util/ArrayList;)I
    ...
    .line 83
    :cond_0
    iget-object v1, p0, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->mPreferences:Lamo;
    ...
    .line 84
    invoke-virtual {v1, v2, v3}, Lamo;->a(Ljava/lang/String;I)I
    ...
    .line 89
    iget-object v5, p0, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->mPreferences:Lamo;

    const-string v6, "ext_dict_version"

    invoke-virtual {v5, v6, v3}, Lamo;->a(Ljava/lang/String;I)V
...
.method private updateOneVersion(Ljava/lang/String;)I
    ...
    sget-object v1, Lcom/google/android/apps/inputmethod/libs/hmm/sync/MessageTypes;->TYPE_SYSDICT_DELTA_PACKAGE:Lcam;

    invoke-direct {v5, v1}, Lcal;-><init>(Lcam;)V
    ...
    invoke-virtual {v5, v1}, Lcal;->a([B)Lcal;

    .line 114
    const/4 v1, 0x3

    invoke-virtual {v5, v1}, Lcal;->a(I)I
    ...
    .line 125
    invoke-virtual {v5, v7, v4}, Lcal;->a(II)Lcal;

    move-result-object v7

    .line 126
    invoke-direct {p0, v7}, Lcom/google/android/apps/inputmethod/libs/hmm/sync/NewWordsUpdateTask;->getEntry(Lcal;)Lcom/google/android/apps/inputmethod/libs/hmm/MutableDictionaryAccessorInterface$Entry;
