...
.method private final a()I
    ...
    invoke-static {v1, v2, v3}, Lakx;->b(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private final varargs a()Ljava/lang/Boolean;
    ...
    iget-object v0, v0, Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;->a:Laoi;

    const v1, 0x7f0f0021

    .line 3
    invoke-virtual {v0, v1}, Laoi;->a(I)Ljava/lang/CharSequence;
    ...
    .line 7
    new-instance v6, Lazo;

    invoke-direct {v6, v1}, Lazo;-><init>(Ljava/util/UUID;)V
    ...
    iput-object v0, v6, Lazo;->a:Ljava/lang/String;

    .line 13
    new-instance v0, Lazo;

    invoke-direct {v0, v2}, Lazo;-><init>(Ljava/util/UUID;)V
    ...
    iput-object v1, v0, Lazo;->a:Ljava/lang/String;

    .line 15
    invoke-virtual {v3, v6}, Lcom/google/android/apps/inputmethod/libs/omaha/OmahaRequest;->a(Lazo;)V

    .line 16
    invoke-virtual {v3, v0}, Lcom/google/android/apps/inputmethod/libs/omaha/OmahaRequest;->a(Lazo;)V
    ...
    iget-object v2, v0, Lazp;->a:Ljava/lang/String;
    ...
    .line 28
    iget-object v1, v0, Lazp;->a:Lazr;

    if-eqz v1, :cond_3

    iget-object v1, v0, Lazp;->a:Lazr;

    iget-object v1, v1, Lazr;->a:Ljava/util/ArrayList;
    ...
    iget-object v9, v2, Lazs;->c:Ljava/lang/String;

    iget v10, v2, Lazs;->a:I

    int-to-long v10, v10

    iget-object v2, v2, Lazs;->b:Ljava/lang/String;
    ...
    iget-object v0, v0, Lazp;->a:Lazr;

    iget-object v0, v0, Lazr;->a:Ljava/lang/String;
