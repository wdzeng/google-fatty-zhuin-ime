...
.field public final mDownloadableDataManager:Lact;
...
.field public final mPreferences:Lamo;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mPreferences:Lamo;

    .line 14
    invoke-static {}, Lge;->a()Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager;

    move-result-object v0

    check-cast v0, Lact;

    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mDownloadableDataManager:Lact;

    .line 15
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mDownloadableDataManager:Lact;

    invoke-virtual {v0}, Lact;->isInitialized()Z
    ...
    invoke-virtual {v0, p1, v1}, Lact;->init(Landroid/content/Context;I)Z
...
.method public static final appendItemToDictionaryDataSetting(Lccg;Ljava/lang/String;I)V
    .locals 3
    ...
    .line 256
    iput-object p1, v0, Lcch;->a:Ljava/lang/String;

    .line 257
    iput p2, v0, Lcch;->a:I

    .line 258
    iget-object v1, p0, Lccg;->a:[Lcch;
    ...
    new-array v1, v1, [Lcch;

    const/4 v2, 0x0

    aput-object v0, v1, v2

    iput-object v1, p0, Lccg;->a:[Lcch;
    ...
    invoke-static {v1, v0}, Lge;->a([Ljava/lang/Object;Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object v0

    check-cast v0, [Lcch;

    iput-object v0, p0, Lccg;->a:[Lcch;

    goto :goto_0
.end method

.method private appendMutableDictionaryToDictionaryDataSetting(Lccg;Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory$MutableDictionaryType;)V
    .locals 2
    ...
    .line 251
    invoke-static {p1, v0, v1}, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->appendItemToDictionaryDataSetting(Lccg;Ljava/lang/String;I)V
...
.method private checkAndRefreshMutableDictionaryDataSetting(I)V
    ...
    .line 341
    :cond_1
    iget-object v1, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mPreferences:Lamo;

    .line 342
    const/4 v2, 0x0

    invoke-virtual {v1, v0, v2}, Lamo;->a(IZ)Z
...
.method private enrollDataSchemeInPackage(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Z
    ...
    .line 53
    iget-object v1, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mDownloadableDataManager:Lact;

    invoke-virtual {v1, p1}, Lact;->getDataPackageFolder(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Ljava/io/File;
...
.method private getDataSchemeFromFolder(Ljava/io/File;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Lcom/google/i18n/input/engine/hmm/proto/nano/Data$DataScheme;
    ...
    invoke-static {v1, v0}, Lcie;->a(Lcie;[B)Lcie;
...
.method private installLstmFile(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v0, p1}, Lact;->getDataPackageFolder(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Ljava/io/File;
...
.method private loadAndUpdateEngineSettingScheme(I)Lccs;
    .locals 5
    ...
    .line 230
    :try_start_0
    invoke-static {v2}, Lccs;->a([B)Lccs;
    :try_end_0
    ...
    .line 236
    invoke-virtual {p0, p1, v0}, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->updateEngineSettingScheme(ILccs;)V
...
.method private updateDataPath(Lcom/google/i18n/input/engine/hmm/proto/nano/Data$DataScheme;Ljava/io/File;Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)V
    ...
    .prologue
    .line 74
    iget-object v2, p1, Lcom/google/i18n/input/engine/hmm/proto/nano/Data$DataScheme;->a:[Lcbx;
    ...
    .line 76
    iget-object v0, v4, Lcbx;->a:Ljava/lang/String;
    ...
    iget-object v5, v4, Lcbx;->a:Ljava/lang/String;
    ...
    iput-object v0, v4, Lcbx;->a:Ljava/lang/String;
...
.method private updateDictionaryDataSetting(ILccg;)V
    .locals 5
    ...
    .line 244
    invoke-direct {p0, p2, v3}, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->appendMutableDictionaryToDictionaryDataSetting(Lccg;Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory$MutableDictionaryType;)V
...
.method public enrollDataScheme()V
    ...
    .line 40
    :cond_0
    iget-object v2, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mDownloadableDataManager:Lact;

    const/4 v3, 0x0

    invoke-virtual {v2, p0, v3}, Lact;->registerDataConsumer(Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager$DownloadableDataConsumer;Ljava/util/Locale;)V

    .line 41
    iget-object v2, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mDownloadableDataManager:Lact;

    invoke-virtual {v2, p0}, Lact;->getDataPackageDefsForConsumer(Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager$DownloadableDataConsumer;)[Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;
    ...
    .line 46
    iget-object v6, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mDownloadableDataManager:Lact;

    invoke-virtual {v6, v5}, Lact;->isDownloaded(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Z
...
.method public final enrollMutableDictionary(Landroid/content/Context;Ljava/lang/String;II)V
    ...
    invoke-static {v1, v2}, Lakx;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_3
    ...
    invoke-static {v0, v1}, Lakx;->c(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getConsumerId()Ljava/lang/String;
    ...
    invoke-static {v0}, Lakx;->a(Ljava/lang/String;)V
...
.method public initialize()V
    ...
    .prologue
    .line 19
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mPreferences:Lamo;
...
.method public initializePreferences()V
    ...
    iget-object v3, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mPreferences:Lamo;
...
.method public isDownloadingData()Z
    ...
    invoke-virtual {v1, p0}, Lact;->getDataPackageDefsForConsumer(Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager$DownloadableDataConsumer;)[Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;
    ...
    .line 121
    iget-object v5, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mDownloadableDataManager:Lact;

    invoke-virtual {v5, v4}, Lact;->isDownloading(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Z
...
.method public onDownloadableDataToBeRemoved(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)V
    ...
    invoke-virtual {v2, p1}, Lact;->getDataPackageFolder(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Ljava/io/File;
    ...
    invoke-virtual {v0, p0}, Lact;->getDataPackageDefsForConsumer(Lcom/google/android/apps/inputmethod/libs/dataservice/download/IDownloadableDataManager$DownloadableDataConsumer;)[Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;
    ...
    .line 156
    invoke-virtual {v5, v4}, Lact;->isDownloaded(Lcom/google/android/apps/inputmethod/libs/dataservice/download/DataPackageDef;)Z
...
.method public onSharedPreferenceChanged(Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    .line 334
    iget-object v2, p0, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->mPreferences:Lamo;

    invoke-virtual {v2, p2, v1}, Lamo;->a(Ljava/lang/String;I)Z
...
.method protected shouldEnrollMutableDictionary(ILcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory$MutableDictionaryType;)Z
    .locals 2
...
.method public updateAllEngineSettingSchemes()V
    ...
    .line 202
    invoke-direct {p0, v0}, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->loadAndUpdateEngineSettingScheme(I)Lccs;
    ...
    .line 206
    invoke-static {v2}, Lccs;->a(Lcie;)[B
...
.method public updateEngineSettingScheme(ILccs;)V
    .locals 1

    .prologue
    .line 238
    iget-object v0, p2, Lccs;->b:Lccg;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/apps/inputmethod/libs/hmm/AbstractHmmEngineFactory;->updateDictionaryDataSetting(ILccg;)V
