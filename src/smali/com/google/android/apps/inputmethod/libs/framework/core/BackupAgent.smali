...
.method public final onRestore(Landroid/app/backup/BackupDataInput;ILandroid/os/ParcelFileDescriptor;)V
    ...
    .line 8
    invoke-static {p0}, Lamo;->a(Landroid/content/Context;)V
    ...
    .line 14
    :try_start_1
    iget-object v6, v5, Lamo;->a:Landroid/content/res/Resources;
    ...
    .line 15
    invoke-virtual {v5, v0}, Lamo;->c(Ljava/lang/String;)V

    .line 16
    invoke-virtual {v5}, Lamo;->a()Landroid/content/SharedPreferences$Editor;
    ...
    :try_start_2
    invoke-static {v0, v5}, Lamo;->a(Landroid/content/SharedPreferences$Editor;Z)V
    :try_end_2
    ...
    invoke-static {v5, v0}, Lakx;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
