...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laoi;

    .line 12
    sget-object v0, Laox;->a:Laox;

    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laox;

    .line 13
    sget-object v0, Laou;->a:Laou;

    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laou;
    ...
    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laoj;

    .line 21
    invoke-static {}, Laox;->a()Laoy;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laoy;

    .line 23
    invoke-static {}, Laou;->a()Laov;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laov;

    .line 25
    invoke-static {}, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/KeyboardGroupDef;->a()Laoq;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laoq;
...
.method public final a()Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;
    ...
    .line 66
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laoj;

    invoke-virtual {v0}, Laoj;->reset()Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/IBuilder;

    .line 67
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laoy;

    invoke-virtual {v0}, Laoy;->reset()Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/IBuilder;

    .line 68
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laov;

    invoke-virtual {v0}, Laov;->reset()Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/IBuilder;

    .line 69
    iget-object v0, p0, Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;->a:Laoq;

    invoke-virtual {v0}, Laoq;->a()Laoq;
...
.method public final a(Lcom/google/android/apps/inputmethod/libs/framework/core/SimpleXmlParser;)Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/ImeDef$a;
    ...
    invoke-direct {v7, v8, v9, v6, v5}, Lcom/google/common/base/Splitter;-><init>(Lcom/google/common/base/Splitter$a;ZLbxg;I)V

    .line 110
    invoke-static {v0, v3, v1, v7}, Lge;->a(Landroid/content/Context;Landroid/util/AttributeSet;ILcom/google/common/base/Splitter;)[I
    ...
    .line 118
    invoke-static {v0, v5}, Lge;->a(Ljava/lang/String;Ljava/lang/Enum;)Ljava/lang/Enum;
    ...
    invoke-static {v0}, Laju;->b(Ljava/lang/String;)I
...
.method public final handleNode(Lcom/google/android/apps/inputmethod/libs/framework/core/SimpleXmlParser;)V
    ...
    invoke-virtual {v0, p1}, Laoq;->a(Lcom/google/android/apps/inputmethod/libs/framework/core/SimpleXmlParser;)Laoq;
    ...
    invoke-virtual {v0, p1}, Laoj;->parse(Lcom/google/android/apps/inputmethod/libs/framework/core/SimpleXmlParser;)Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/IBuilder;
    ...
    invoke-virtual {v0, p1}, Laoy;->parse(Lcom/google/android/apps/inputmethod/libs/framework/core/SimpleXmlParser;)Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/IBuilder;
    ...
    invoke-virtual {v0, p1}, Laov;->parse(Lcom/google/android/apps/inputmethod/libs/framework/core/SimpleXmlParser;)Lcom/google/android/apps/inputmethod/libs/framework/core/metadata/IBuilder;
