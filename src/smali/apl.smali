...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lapl;->a:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lapl;->b:Landroid/view/View$OnClickListener;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 20
    invoke-virtual {p0, v2}, Lapl;->requestWindowFeature(I)Z

    .line 21
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lapl;->setTitle(Ljava/lang/CharSequence;)V

    .line 22
    const v0, 0x7f040031

    invoke-virtual {p0, v0}, Lapl;->setContentView(I)V

    .line 23
    invoke-direct {p0}, Lapl;->a()[I

    move-result-object v0

    iput-object v0, p0, Lapl;->a:[I

    .line 24
    iget-object v0, p0, Lapl;->a:[I
    ...
    .line 25
    :cond_0
    invoke-virtual {p0}, Lapl;->finish()V
    ...
    invoke-virtual {p0, v0}, Lapl;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/BidiViewPager;

    iput-object v0, p0, Lapl;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/BidiViewPager;

    .line 28
    iget-object v0, p0, Lapl;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/BidiViewPager;

    .line 29
    new-instance v1, Lapo;

    invoke-direct {v1, p0}, Lapo;-><init>(Lapl;)V
    ...
    iput-object v0, p0, Lapl;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/PageIndicatorView;

    .line 32
    iget-object v0, p0, Lapl;->a:Lcom/google/android/apps/inputmethod/libs/framework/keyboard/widget/PageIndicatorView;

    iget-object v1, p0, Lapl;->a:[I
    ...
    iput-object v0, p0, Lapl;->a:Landroid/view/View;

    .line 36
    iget-object v0, p0, Lapl;->a:Landroid/view/View;

    iget-object v1, p0, Lapl;->a:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lapl;->b:Landroid/view/View;

    .line 38
    iget-object v0, p0, Lapl;->b:Landroid/view/View;

    iget-object v1, p0, Lapl;->b:Landroid/view/View$OnClickListener;
