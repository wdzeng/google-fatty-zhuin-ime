...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lacb;->a:Landroid/text/style/CharacterStyle;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lacb;->b:Landroid/text/style/CharacterStyle;
    ...
    iput-object v0, p0, Lacb;->a:Lcom/google/android/apps/inputmethod/libs/hmm/InputType;
    ...
    .line 11
    iput-object v0, p0, Lacb;->a:Ljava/util/List;
    ...
    iput-object v1, p0, Lacb;->d:Landroid/text/style/CharacterStyle;
    ...
    iput-object v1, p0, Lacb;->e:Landroid/text/style/CharacterStyle;
    ...
    iput-object v2, p0, Lacb;->c:Landroid/text/style/CharacterStyle;

    .line 17
    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    .line 18
    iput-boolean p2, p0, Lacb;->c:Z

    .line 19
    invoke-virtual {p0}, Lacb;->reset()V
...
.method public final appendInputUnit(Lcom/google/android/apps/inputmethod/libs/hmm/IHmmComposingTextRenderer$InputUnitInfo;)V
    ...
    .prologue
    .line 119
    iget-object v0, p0, Lacb;->a:Landroid/text/SpannableStringBuilder;
    ...
    .line 120
    iget-object v1, p0, Lacb;->a:Landroid/text/SpannableStringBuilder;
    ...
    invoke-virtual {p0, v2}, Lacb;->convertInputUnitString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-boolean v1, p0, Lacb;->a:Z

    .line 122
    iget-object v1, p0, Lacb;->f:Landroid/text/style/CharacterStyle;

    if-nez v1, :cond_0

    .line 124
    iget-object v1, p0, Lacb;->e:Landroid/text/style/CharacterStyle;
    ...
    .line 125
    iput-object v1, p0, Lacb;->f:Landroid/text/style/CharacterStyle;
    ...
    iget-object v3, p0, Lacb;->a:Landroid/text/SpannableStringBuilder;
...
.method public final appendSegment(Lcom/google/android/apps/inputmethod/libs/hmm/IHmmComposingTextRenderer$SegmentInfo;)V
    ...
    .line 45
    invoke-direct {p0}, Lacb;->b()Z

    move-result v3

    iget-object v4, p0, Lacb;->a:Lcom/google/android/apps/inputmethod/libs/hmm/InputType;
    ...
    .line 46
    invoke-static/range {v0 .. v5}, Lacb;->a(IZIZLcom/google/android/apps/inputmethod/libs/hmm/InputType;Lcom/google/android/apps/inputmethod/libs/hmm/InputType;)Z
    ...
    .line 50
    iput-object p1, p0, Lacb;->a:Lcom/google/android/apps/inputmethod/libs/hmm/IHmmComposingTextRenderer$SegmentInfo;
...
.method public final appendToken(Lcom/google/android/apps/inputmethod/libs/hmm/IHmmComposingTextRenderer$TokenInfo;)V
    ...
    .line 53
    iget-object v0, p0, Lacb;->a:Ljava/util/List;
    ...
    iget-object v1, p0, Lacb;->a:Lcom/google/android/apps/inputmethod/libs/hmm/IHmmComposingTextRenderer$SegmentInfo;
    ...
    .line 56
    invoke-virtual {p0, v1}, Lacb;->convertSegmentString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lacb;->a:Ljava/util/List;

    .line 57
    invoke-static {v1, v2}, Lge;->a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    .line 81
    iget-object v0, p0, Lacb;->f:Landroid/text/style/CharacterStyle;
    ...
    .line 83
    :cond_4
    iget-object v0, p0, Lacb;->d:Landroid/text/style/CharacterStyle;
    ...
    .line 84
    iput-object v0, p0, Lacb;->f:Landroid/text/style/CharacterStyle;
    ...
    .line 106
    :goto_3
    invoke-virtual {p0, v0}, Lacb;->convertTokenString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lacb;->a:Lcom/google/android/apps/inputmethod/libs/hmm/InputType;
    ...
    .line 90
    :cond_c
    iget-object v1, p0, Lacb;->c:Landroid/text/style/CharacterStyle;
    ...
    .line 97
    :cond_e
    iget-object v1, p0, Lacb;->b:Landroid/text/style/CharacterStyle;
...
.method public final getComposingText()Ljava/lang/CharSequence;
    ...
    sget-object v1, Lacb;->a:Landroid/text/style/CharacterStyle;
...
.method public final reset()V
    ...
    iput-object v0, p0, Lacb;->a:Landroid/text/SpannableStringBuilder;
