...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lahs;->a:Ljava/util/ArrayDeque;
    ...
    invoke-direct {v0, v1}, Laht;-><init>(Landroid/os/Looper;)V
...
.method public static a()Lahs;
    ...
    iput-object v2, v1, Laht;->a:Ljava/lang/ref/WeakReference;
...
.method final declared-synchronized a(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lahs;->a:Ljava/util/HashMap;
    ...
    .line 37
    iget-object v1, p0, Lahs;->a:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lahs;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/Task;

    .line 39
    iput-object p1, p0, Lahs;->a:Ljava/lang/String;
...
.method public final declared-synchronized a(Ljava/lang/String;Lcom/google/android/apps/inputmethod/libs/framework/core/TaskFactory;J)V
    ...
    invoke-virtual {p0, v0, v1}, Lahs;->a(Ljava/lang/String;Z)V

    .line 16
    iget-object v1, p0, Lahs;->a:Laht;

    iget-object v2, p0, Lahs;->a:Laht;

    const/4 v3, 0x1

    invoke-virtual {v2, v3, v0}, Laht;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    invoke-virtual {v1, v2, p3, p4}, Laht;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public final declared-synchronized a(Ljava/lang/String;Z)V
    ...
    .line 21
    invoke-virtual {p0, v0}, Lahs;->a(Ljava/lang/String;)Z
    ...
    .line 22
    iget-object v1, p0, Lahs;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/Task;

    invoke-virtual {v1, p2}, Lcom/google/android/apps/inputmethod/libs/framework/core/Task;->cancel(Z)Z

    .line 23
    :cond_0
    iget-object v1, p0, Lahs;->a:Ljava/util/ArrayDeque;
    ...
    invoke-virtual {v1, v2, v0}, Laht;->removeMessages(ILjava/lang/Object;)V
...
.method public final declared-synchronized a(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v0, p0, Lahs;->a:Ljava/lang/String;
...
.method public final declared-synchronized onTaskFinished(ZLjava/lang/Object;)V
    ...
    :try_start_0
    iput-object v0, p0, Lahs;->a:Lcom/google/android/apps/inputmethod/libs/framework/core/Task;

    .line 30
    const/4 v0, 0x0

    iput-object v0, p0, Lahs;->a:Ljava/lang/String;

    .line 31
    iget-object v0, p0, Lahs;->a:Ljava/util/ArrayDeque;
