...
# direct methods
.method public constructor <init>(Lbpk;Lcom/google/android/apps/inputmethod/libs/framework/concurrent/ThreadInfoDumper;ILagf;ZI)V
    .locals 4
    ...
    iput-object v0, p0, Lagi;->a:Ljava/util/concurrent/atomic/AtomicLong;

    .line 3
    iput-object p1, p0, Lagi;->a:Lbpk;

    .line 4
    iput-object p2, p0, Lagi;->a:Lcom/google/android/apps/inputmethod/libs/framework/concurrent/ThreadInfoDumper;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lagi;->setKeepAliveTime(JLjava/util/concurrent/TimeUnit;)V

    .line 6
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lagi;->allowCoreThreadTimeOut(Z)V
...
.method protected final afterExecute(Ljava/lang/Runnable;Ljava/lang/Throwable;)V
    ...
    .line 14
    invoke-static {p1, p2}, Lagi;->a(Ljava/lang/Runnable;Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method protected final decorateTask(Ljava/lang/Runnable;Ljava/util/concurrent/RunnableScheduledFuture;)Ljava/util/concurrent/RunnableScheduledFuture;
    ...
    .prologue
    .line 8
    iget-object v0, p0, Lagi;->a:Lcom/google/android/apps/inputmethod/libs/framework/concurrent/ThreadInfoDumper;
    ...
    iget-object v2, p0, Lagi;->a:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-direct/range {v0 .. v7}, Lagl;-><init>(Lbpk;Ljava/lang/Runnable;Lcom/google/android/apps/inputmethod/libs/framework/concurrent/TaskInfo;JJ)V
